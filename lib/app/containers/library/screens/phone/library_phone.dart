...
class LibraryPhone extends StatefulWidget {
  LibraryPhone({Key key}) : super(key: key);

  @override
  _LibraryPhoneState createState() => _LibraryPhoneState();
}
...
class _LibraryPhoneState extends State<LibraryPhone> {
  ...
  _intData() async {
    final location = await LocalData().read("library-location");
    print(location);
    return location;
  }
  ...
  _onTryToAccess() async {
    final data = {
      "location": {"lat": "-0.0000", "lng": "0.0000", "city": "chefchaouen"},
      "phone": _controllerPhone.text,
    };
    await LocalData().save("in-phone-verify-data", data);
    await localdata.save("redirect", iSFORLIBRARY);
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              "Please use your whatsapp number for additional contact",
                              style: TextStyle(
                                fontFamily: rLight,
                                fontSize: 14,
