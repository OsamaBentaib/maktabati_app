...
class AddNoteBookCover extends StatefulWidget {
  AddNoteBookCover({Key key}) : super(key: key);

  @override
  _AddNoteBookCoverState createState() => _AddNoteBookCoverState();
}

class _AddNoteBookCoverState extends State<AddNoteBookCover> {
  String selectedSize = "";
  ...
  _onhandelSubmit() async {
    ...
    if (selectedSize != "" &&
        selectedLevel != "" &&
        _controllerColor.text.toString() != "") {
      setState(() {
        loading = true;
      });
      final data = <String, dynamic>{
        ...
        "noteBookCover": {
          "size": selectedSize,
          "color": _controllerColor.text.toString()
        },
      };
  ...
  _onhandelSelectSize(String size) {
    setState(() {
      selectedSize = size;
    });
    _setValid();
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  GestureDetector(
                                    onTap: () => _onhandelSelectSize("Large"),
                                    child: Container(
                                      width: 80,
                                      height: 110,
                                      decoration: BoxDecoration(
                                  ...
                                  GestureDetector(
                                    onTap: () => _onhandelSelectSize("Small"),
                                    child: Container(
                                      width: 80,
                                      height: 80,
                                      decoration: BoxDecoration(
