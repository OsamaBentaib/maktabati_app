...
class ParentsDashboardBody extends StatefulWidget {
  const ParentsDashboardBody({Key key}) : super(key: key);

  @override
  _ParentsDashboardBodyState createState() => _ParentsDashboardBodyState();
}

class _ParentsDashboardBodyState extends State<ParentsDashboardBody> {
  APIConnect apiConnect = APIConnect();
  TeacherDashboardLocalData localdata = TeacherDashboardLocalData();
  List snapshot;
  bool logoutModal = false;
  _onlogout() async {
    await localdata.remove("parents-access");
